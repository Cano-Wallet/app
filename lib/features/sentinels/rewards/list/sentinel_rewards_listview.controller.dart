...
class SentinelRewardsListViewController extends BaseListController {
  final List<Widget> headers;
  SentinelRewardsListViewController({this.headers = const []});

  static SentinelRewardsListViewController get to => Get.find();
  ...
  Future<void> fetch({bool loadMore = false}) async {
    ...
    try {
      object = await Zenon().embedded.sentinel.getFrontierRewardByPage(
            viewingAddress!,
            pageIndex: pageIndex,
            pageSize: pageSize,
          );
