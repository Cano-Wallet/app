...
class PillarRewardsListViewController extends BaseListController {
  final List<Widget> headers;
  PillarRewardsListViewController({this.headers = const []});

  static PillarRewardsListViewController get to => Get.find();
  ...
  Future<void> fetch({bool loadMore = false}) async {
    ...
    try {
      object = await Zenon().embedded.pillar.getFrontierRewardByPage(
            viewingAddress!,
            pageIndex: pageIndex,
            pageSize: pageSize,
          );
